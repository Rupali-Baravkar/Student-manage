                        ...
                        <form action="{{ route('students.update', $student->id)}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div data-mdb-input-init class="form-outline">
                                        <input type="text" id="firstName" name="first_name" value="{{ old('first_name', $student->first_name)}}" class="form-control form-control-lg" />
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div data-mdb-input-init class="form-outline">
                                        <input type="text" id="lastName" name="last_name" value="{{old('last_name', $student->last_name)}}" class="form-control form-control-lg" />
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 d-flex align-items-center">
                                    ...
                                    <div data-mdb-input-init class="form-outline datepicker w-100">
                                        <input type="text" class="form-control form-control-lg" name="dob" value="{{old('dob', $student->dob)}}" id="birthdayDate" />
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="maleGender"
                                            value="male" {{ old('gender', $student->gender) == 'male' ? 'checked' : '' }} />
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 pb-2">
                                    ...
                                    <div data-mdb-input-init class="form-outline">
                                        <input type="email" id="emailAddress" name="email" value="{{old('email', $student->email)}}" class="form-control form-control-lg" />
                                ...
                                <div class="col-md-6 mb-4 pb-2">
                                    ...
                                    <div data-mdb-input-init class="form-outline">
                                        <input type="tel" id="phoneNumber" name="phone" value="{{old('phone', $student->phone)}}" class="form-control form-control-lg" />
